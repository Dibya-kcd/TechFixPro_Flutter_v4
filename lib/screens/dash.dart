...
class DashScreen extends ConsumerWidget {
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          PBtn(
            label: 'Verify',
            onTap: () {
              if (pinCtrl.text == tech.pin) {
                // In a real app, you'd update the session/auth here. 
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final ownerName = settings.ownerName.isEmpty ? 'Admin' : settings.ownerName;
                      ...
                      child: LineChart(
                        LineChartData(
                          ...
                          lineBarsData: [
                            LineChartBarData(
                              spots: const [
                                FlSpot(0, 12), FlSpot(1, 18.5), FlSpot(2, 14.2),
                                FlSpot(3, 22), FlSpot(4, 19.5), FlSpot(5, 31), FlSpot(6, 28.5),
                              ],
