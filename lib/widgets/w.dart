  ...
  Widget build(BuildContext context) => Column(
    ...
    children: [
      ...
      DropdownButtonFormField<T>(
        initialValue: value, onChanged: onChanged, items: items,
...
// ─────────────────────────────────────────────────────────────
//  PhotoRow — displays captured photos + add button
//  Paths: '' (emoji placeholder) or actual file system paths
// ─────────────────────────────────────────────────────────────
      ...
      SingleChildScrollView(
        ...
        child: Row(children: [
          ...
          ...photos.asMap().entries.map((e) => _PhotoTile(
            path: e.value,
            index: e.key,
            onDelete: canDelete && onPhotoRemoved != null
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                const Icon(Icons.add_a_photo_outlined, color: C.primary, size: 26),
                const SizedBox(height: 4),
                Text('Add Photo', style: GoogleFonts.syne(
                    fontSize: 9, color: C.primary, fontWeight: FontWeight.w700)),
              ]),
            ),
          ),
        ]),
...
class _PhotoTile extends StatelessWidget {
  ...
  const _PhotoTile({required this.path, required this.index, this.onDelete});
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: GestureDetector(
      onTap: () => _isEmoji ? null : _viewFullScreen(context),
      child: Stack(clipBehavior: Clip.none, children: [
        ...
        // Full-screen indicator for real images
